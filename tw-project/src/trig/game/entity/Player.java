...
//    {
//        //normalise the new direction on every update, so the value never gets to infinity (or out of bounds of the float type/NaN, whatever happens in java), which would reek havoc!
//        direction = MathUtils.normalise(getDirection()+delta);
